  ...
  return (
    <div className="min-h-screen flex flex-col items-center relative">
      ...
      <div className="flex items-center">
        <Image src="/muthoot_logo.png" alt="Muthoot Logo" width={40} height={40} className="mr-4 rounded-xl muthootIcon" />
      </div>
      <div className="flex-1 flex justify-center">
        <div className="flex space-x-5 sm:space-x-6 md:space-x-16 xl:space-x-20 items-center">
        <button className=" headerButton !text-muthootRed">Register</button>
        <button className="headerButton">Login</button>
        <button className="headerButton ">Contact</button>
        <button className="headerButton hidden sm:block">About</button>
        </div>
      </div>
      </div>
      ...
      </div><div className="flex-1 p-2 lg:p-20">
