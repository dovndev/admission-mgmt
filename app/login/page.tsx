        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-background">
          ...
          <div className="flex flex-auto justify-center items-center w-full">
            <div className="bg-textBoxBackground relative shadow rounded-3xl p-8 max-w-2xl w-full">
              <h2 className="text-2xl font-semibold mb-6 text-center text-muthootRed">{isAdmin ? "Admin Login" : "Login"}</h2>
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                  <FloatingLabelInput id="password" type="password" label="Password" required autoComplete="current-password" value={formData.password} onChange={handleChange} />
                </div>
              ...
              <div className="h-[40px] w-full flex justify-end items-end">
                <Link href={isAdmin ? "/forgotPassword?admin=true" : "/forgotPassword"} className="border-b mauto">
                  Forgot password
                </Link>
              </div>
            </div>
