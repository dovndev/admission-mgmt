...
export default function EducationalDetails() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full p-3">
      <div className="bg-textBoxBackground relative shadow-xl rounded-3xl p-4 sm:p-8 w-full max-w-[100%] sm:max-w-6xl ">
        ...
        <div className="flex flex-col grid-rows-4 gap-10 md:flex-row space-y-4 md:space-y-0 md:space-x-4">
          <div className="flex flex-1 flex-col gap-10 ">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4 md:flex-row ">
                <FloatingLabelInput
                  id={"_10thSchool"}
                  label={"Name of School/Institution attended for SSLC/AISSE(10th)*"}
                  autoComplete="school"
                  required={true}
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4 md:flex-row ">
                <FloatingLabelInput
                  id={"_12thSchool"}
                  label={"Name of School/Institution attended for qualifying exam (+2/12th)*"}
                  autoComplete="school"
                  required={false}
                  onChange={handleChange}
          ...
          <div className="flex flex-1 flex-col gap-6">
            ...
            <div className="flex flex-col text-center gap-4 w-full justify-around">
              <span className="text-red-500 p-2 rounded-lg">
                Note: After selecting the mark list make sure you click UPLOAD button. Your ast change will be saved, you can
                also use the upload button to change the file later.
              </span>{" "}
