    ...
    <div className="relative z-10 bg-white bg-opacity-[15%] shadow max-w-[95%] w-full h-auto min-h-[60px] mt-5 mx-auto rounded-3xl flex items-center px-3 sm:px-6 py-2 backdrop-blur-sm">
      ...
      <div className="flex-1 flex justify-center items-center">
        <div className="flex flex-row space-x-3 sm:space-x-4 md:space-x-6 lg:space-x-8 items-center">
          <Link
            href="/register"
            className="headerButton font-sans font-medium !text-muthootRed text-center relative transition-all duration-300 hover:!text-white hover:drop-shadow-md hover:after:w-full after:content-[''] after:absolute after:w-0 after:h-px after:bg-white after:right-0 after:-bottom-1 after:transition-all after:duration-300"
          >
            Register
          </Link>
          <Link
            href="/login"
            className={`headerButton font-sans font-medium ${mode === "dark" ? "text-white" : ""} ${mode === "light" ? "text-black" : ""} text-center relative transition-all duration-300 hover:drop-shadow-md hover:after:w-full after:content-[''] after:absolute after:w-0 after:h-px after:bg-current after:left-0 after:-bottom-1 after:transition-all after:duration-300`}
          >
            Login
          </Link>
        </div>
